...
This article explains about how to load image from Camera (or) Gallery using the [Syncfusion Xamarin.Forms SfImageEditor](https://help.syncfusion.com/cr/xamarin/Syncfusion.SfImageEditor.XForms.SfImageEditor.html) control.
